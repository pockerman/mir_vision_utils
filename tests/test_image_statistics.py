...
from visionutils.statistics.image_statistics import compute_image_channels_means
from visionutils.statistics.image_statistics import compute_image_channels_variance
